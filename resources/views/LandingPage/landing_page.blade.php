         ...
         <div class="bg-white rounded-shadow-md bg-opacity-100 p-8 w-[30%] m-auto rounded-[30px]">
            <div class="p-4 md:p-5">
                <form class="space-y-4 " action="#">
                    ...
                    <div>
                        <button class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-300 dark:text-white font-[Poppins]" style="color:white; font-size: 20px; background-color:#038175;" onclick="klikPemilikCostum()">Pemilik Kostum</button>
                    </div>
                </form>
            </div>
         </div>
