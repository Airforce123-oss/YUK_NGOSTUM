...
<div class="container mx-auto p-9 max-w-6xl bg-white rounded-xl shadow-md mt-8">
    <div class="mb-6">
        <h2 class="text-3xl font-bold text-gray-800">Update Kostum</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="col-span-2">
                ...
                <div class="mt-6 flex justify-end">
                    <button type="submit" class="inline-flex items-center px-12 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-900">Simpan Perubahan</button>
                </div>
            </div>
        </div>
    </form>
