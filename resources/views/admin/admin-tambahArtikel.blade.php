                ...
                <div class="bg-gray-50 p-4 rounded-lg shadow-inner mb-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-4">General</h3>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" name="title" id="title" class="mt-1 block w-full pl-3 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Masukkan Nama Kostum" required>
                        </div>
                        <div class="col-span-1">
                            <label for="content" class="block text-sm font-medium text-gray-700">Content</label>
                            <textarea name="content" id="content" cols="30" rows="10" class="mt-1 block w-full pl-3 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Masukkan Deskripsi Kostum" required></textarea>
